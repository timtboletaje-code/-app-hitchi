(function () {
  ...
  async function seed() {
    ...
    const defaults = [
      ...
      { nombre: "Mariano Zarate", rol: "tecnico", activo: 1 },
      { nombre: "Admin Test", rol: "admin", activo: 1 },
      { nombre: "Brenda Castañeda", rol: "tecnico", activo: 1 },
      { nombre: "Carlos Omar Gonzalez", rol: "tecnico", activo: 1 },
      { nombre: "Cristofer Jimenez", rol: "tecnico", activo: 1 },
      { nombre: "Edwin Arellano Peralta", rol: "tecnico", activo: 1 },
      { nombre: "Emmanuel Meza", rol: "tecnico", activo: 1 },
      { nombre: "Erik Solis", rol: "tecnico", activo: 1 },
      { nombre: "Ernesto Gutierrez Hdz", rol: "tecnico", activo: 1 },
      { nombre: "Fernando Avellaneda Cruz", rol: "tecnico", activo: 1 },
      { nombre: "Hector Tenorio Garcia", rol: "tecnico", activo: 1 },
      { nombre: "Jorge Alvarez Santiago", rol: "tecnico", activo: 1 },
      { nombre: "Jorge Espinoza", rol: "tecnico", activo: 1 },
      { nombre: "Mario Vargas", rol: "tecnico", activo: 1 },
      { nombre: "Moises Herrera Rojas", rol: "tecnico", activo: 1 },
      { nombre: "Omar Cera Garatachia", rol: "tecnico", activo: 1 },
      { nombre: "Oscar Palacios", rol: "tecnico", activo: 1 },
      { nombre: "Ricardo Monroy Huerta", rol: "tecnico", activo: 1 },
    ];
